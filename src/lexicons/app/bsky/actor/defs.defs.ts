...
const nux = l.typedObject<Nux>(
  ...
  l.object({
    ...
    completed: l.boolean({ default: false }),
...
const mutedWord = l.typedObject<MutedWord>(
  ...
  l.object({
    ...
    expiresAt: l.optional(l.string({ format: 'datetime' })),
    actorTarget: l.optional(l.string({ default: 'all' })),
  }),
)
...
type StatusView = {
   ...
   */
  embed?: l.TypedRef<EmbedExternal.View> | l.TypedObject
...
const feedViewPref = l.typedObject<FeedViewPref>(
  ...
  l.object({
    ...
    hideRepliesByUnfollowed: l.optional(l.boolean({ default: true })),
  }),
)
...
const adultContentPref = l.typedObject<AdultContentPref>(
  $nsid,
  'adultContentPref',
  l.object({ enabled: l.boolean({ default: false }) }),
)
...
const verificationPrefs = l.typedObject<VerificationPrefs>(
  $nsid,
  'verificationPrefs',
  l.object({ hideBadges: l.optional(l.boolean({ default: false })) }),
)
