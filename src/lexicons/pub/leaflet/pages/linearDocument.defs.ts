...
import * as BlocksTex from '../../../dev/atrin/blog/blocks/tex.defs.js'
  ...
  l.object({
    block: l.typedUnion(
      [
        ...
        l.typedRef<BlocksTex.Main>((() => BlocksTex.main) as any),
      ],
      false,
    ),
    alignment: l.optional(l.string()),
  }),
)
